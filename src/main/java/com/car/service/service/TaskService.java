...
import com.car.service.repository.TaskRepository;
...
public class TaskService {
    ...
    public void delete(long taskId){
        taskRepository.findById(taskId).ifPresent(taskEntity -> taskRepository.delete(taskEntity));
    }
    ...
    private PersonEntity createOrUpdate(PersonEntity client) {
        ...
        element.setContact(client.getContact());
